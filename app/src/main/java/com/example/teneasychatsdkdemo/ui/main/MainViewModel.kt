...
import com.example.teneasychatsdkdemo.ui.base.GlideEngine
...
//        listView.smoothScrollToPosition(msgAdapter.itemCount)
    ...
    fun composeAChatmodel(msg: String, isLeft: Boolean) {
        addMsgItem(chatLib.composeAChatmodel(msg, isLeft))
    }
